        ...
        <div className='bg-wallet_black min-w-full'>
            ...
            <div className='flex-1 flex-row text-white'>
                ...
                <div className='flex flex-row items-start mt-3 space-x-4'>
                    ...
                    <div className='bg-white p-1 sm:p-3 rounded-md hover:cursor-pointer' ><img src={apple} className='bg-wallet_green h-4 w-4 sm:h-8 sm:w-8 rounded-full object-contain' alt='apple'/></div>
                    <div className='bg-white p-1 sm:p-3 rounded-md hover:cursor-pointer'><img src={store} className='bg-wallet_green h-4 w-4 sm:h-8 sm:w-8 rounded-full object-contain' alt='apple'/></div>
                </div>
            </div>
