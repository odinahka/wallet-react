    ...
    return (
        <div className='bg-white h-screen w-screen flex flex-col justify-center'>
            <div className='flex-1 mt-6'>
                ...
                <div className=' container mx-auto flex-1 flex items-center justify-center my-4'>
                    <p className='text-center xl:text-lg'>Lorem ipsum dolor sit amet, consectetur adispiscing elit, sed do euismod tempor incididunt ut labore et dolore magna aliqua. Ut enim. Lorem ipsum dolor sit amet, consecteur adispiscing elit,</p>
                </div>
            </div>
        </div>
    );
